...
Version 25 adds variable-limit event names. Version 26 adds the remaining
Anti-Magic Shell absorption value, and version 27 adds Ensnare's gradual
flyer land/rise state.
