...
| WC3 simulation pause, Quest modal ownership, client keepalive and input blocking | [docs/games/warcraft-3/pause-and-modal-ui.md](docs/games/warcraft-3/pause-and-modal-ui.md) |
